...
class ObservableTableRepository {
  public:
    ...
    [[nodiscard]] double vectorIT11(double theta_cm_deg) const;
    [[nodiscard]] double tensorT20(double theta_cm_deg) const;
    [[nodiscard]] double tensorT21(double theta_cm_deg) const;
  ...
  private:
    ...
    std::vector<double> vector_it11_angles_deg_;
    std::vector<double> vector_it11_values_;
    std::vector<double> tensor_angles_deg_;
    std::vector<double> tensor_t21_angles_deg_;
    std::vector<double> tensor_t22_angles_deg_;
    std::vector<double> tensor_t20_values_;
    std::vector<double> tensor_t21_values_;
    ...
    std::unique_ptr<TGraph> vector_it11_graph_;
    std::unique_ptr<TGraph> tensor_t20_graph_;
    std::unique_ptr<TGraph> tensor_t21_graph_;
    ...
    std::unique_ptr<TSpline3> vector_it11_spline_;
    std::unique_ptr<TSpline3> tensor_t20_spline_;
    std::unique_ptr<TSpline3> tensor_t21_spline_;
