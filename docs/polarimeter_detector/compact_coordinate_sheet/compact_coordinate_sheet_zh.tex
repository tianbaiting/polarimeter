...
\begin{itemize}[nosep,leftmargin=1.5em]
  \item 12 个探测器（3 通道 $\times$ 4 扇区），塑料闪烁体 \ensuremath{\varnothing} 20\,mm
...
\sffamily\small
\textbf{注意}：上表坐标为活性体\textbf{中心}位置。活性体直径 \ensuremath{\varnothing} 20\,mm、厚度 5.5\,mm。探测器面朝靶心，即活性体前表面（面向靶的一侧）位于 $R - 2.75$\,mm 处。
\end{tcolorbox}
...
\midrule
塑料闪烁体直径        & \ensuremath{\varnothing}\,20.0\,mm & 推荐 \\
闪烁体体厚度        & 5.5\,mm & 当前 CAD 推荐原型 \\
外壳外径          & \ensuremath{\varnothing}\,23.0\,mm & — \\
...
束流通径      & 站点 TBD（当前 CAD 过渡管内径 \ensuremath{\varnothing}\,60.2\,mm） & 站点 TBD（当前包络 \ensuremath{\varnothing}\,80\,mm） \\
