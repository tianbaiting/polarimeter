# Archived PMT Waveform and Impedance-Matching Notes

> Status: historical experiment notes, not an authority for the current CompactInVacuum SiPM
> detector or mechanical design. Missing source screenshots are identified explicitly, and causal
> statements should be treated as hypotheses pending controlled measurements.

*Source screenshots 1753452129490, 1753452429094, and 1753452442226 were not preserved in the repository.*

This waveform has multiple ripples. Initial hypotheses include source/load impedance mismatch and
insufficient sampling rate; a known 50 $\Omega$ termination, measured cable delay, and a higher-bandwidth
repeat measurement are required before assigning a cause.

*Source screenshot 1753963907599 was not preserved in the repository.*
...
*The original 50 $\Omega$ screenshot 1754201471343 was not preserved in the repository.*

The following images are for 1M $\Omega$

*The original 1 M$\Omega$ screenshot 1754201509818 was not preserved in the repository.*

![1 MΩ waveform](assets/5e92409e4199b404d43dd7d3e700360.jpg)

Company’s test video

*The source video frame 1754201626480 was not preserved in the repository.*
...
*Source screenshot 1754204211169 was not preserved in the repository.*

![Small-signal reflection waveform](assets/c4b3c19b5ea35a9e9f86ae1277d31b9.jpg)
...
Impedance matching issues may occur not only at the transmission-line load or PMT source, but also
inside the divider/base and filter networks.
