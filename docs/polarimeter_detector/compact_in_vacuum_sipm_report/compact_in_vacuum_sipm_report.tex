...
\begin{titlepage}
  ...
  \begin{tabularx}{\textwidth}{>{\sffamily\bfseries}L{0.23\textwidth}Y}
    \toprule
    Status & Compact-head and square-chamber preliminary engineering study \\
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{L{0.18\textwidth}Y Y}
    ...
    Chamber & Separate square service-plate chambers: \SI{440}{\milli\meter} by
      \SI{440}{\milli\meter} afterSRC and \SI{450}{\milli\meter} by
      \SI{450}{\milli\meter} pre-SAMURAI & Port map, external-pressure FEA, handling mass,
      and access review for each deployment \\
...
\subsection{Square chamber baseline and legacy mass screen}

The selected CompactInVacuum-afterSRC screening chamber is square with a provisional
\SI{440}{\milli\meter} by \SI{440}{\milli\meter} internal section,
\SI{360}{\milli\meter} body length, and \SI{8}{\milli\meter} wall. The selected
...
\begin{table}[htbp]
  \centering
  \small
  \caption{Earlier \SI{10}{\milli\meter}-wall square-vessel arithmetic retained only as a
  legacy mass screen. It is not the selected afterSRC wall model and ignores ports, weld
  preparations, local reinforcements, and removed material.}
  \begin{tabularx}{\textwidth}{L{0.26\textwidth}L{0.23\textwidth}Y}
    ...
    Nominal wall thickness & \SI{10}{\milli\meter} historical screen &
      Superseded by the provisional \SI{8}{\milli\meter} deployment profiles; neither value
      is releasable without external-pressure buckling analysis and weld details \\
...
\begin{itemize}
  ...
  \item Use a removable top service manifold and planar chamber datums. Group the four
    signal interfaces so that sector extraction, tool access, cable routing, and weld
    distortion can be reviewed directly.
...
\SI{450}{\milli\meter} by \SI{450}{\milli\meter} profile. This is a deliberate integration
choice: planar walls provide direct service-manifold mounting, survey datums, tool access,
and radial sector-removal clearance. A cylindrical chamber is not retained for the afterSRC
compact version.
...
\begin{itemize}
  ...
  \item a removable top service manifold for signal feedthroughs and cable routing;
  \item four deterministic sector-holder interfaces with radial extraction and tool clearance;
...
\begin{itemize}
  ...
  \item approve 5-mm and 6-mm active-thickness detector heads for Gate 1 and the comparison coupons;
