# Contacts and Interface Checklist

## Communication Chain

`user -> spokesperson -> SAMURAI / experiment contact -> beam physicist on shift -> operator`

## Responsible Groups

| Topic | What to ask | Likely contact line |
|---|---|---|
| Polarized ion source (PIS) | polarization mode, spin orientation, Wien filter, spin flip capability | Sekiguchi / Sakai |
