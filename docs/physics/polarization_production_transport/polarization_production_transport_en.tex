...
From the repository root, run \texttt{make -C docs/physics/polarization\_production\_transport en}; replace \texttt{en} with \texttt{verify} to check source PDFs and crops.
