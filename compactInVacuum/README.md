...
The golden cassette is independently generated by `civ.cassette.build_detector_cassette` and checked by `run_freecad_tests.sh` before it is admitted into a sector cartridge.
